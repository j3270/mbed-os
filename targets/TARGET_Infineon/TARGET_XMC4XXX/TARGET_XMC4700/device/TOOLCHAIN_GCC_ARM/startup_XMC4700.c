/** @file startup_XMC4700.c
 *  @brief mbed start-up code for the XMC4700-2048 written in C.
 *
 ...
 *		7. jump into main()
 *
 *  @author Fränz Ney (es16m013@technikum-wien.at), modified for XMC4700 by J. Jordan
 *  @bug No known bugs.
 */
